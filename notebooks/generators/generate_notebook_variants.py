...
VARIANTS = [
    ("notebooks/train/moe-of-sod__v_e8_repro_best_seed43.ipynb", "experiments/v_e8_repro_best_seed43.json", "TRAIN"),
    ("notebooks/train/moe-of-sod__v_e8_repro_best_seed44.ipynb", "experiments/v_e8_repro_best_seed44.json", "TRAIN"),
    ...
    ("notebooks/train/moe-of-sod__v_e8_repro_best_14ep.ipynb", "experiments/v_e8_repro_best_14ep.json", "TRAIN"),
    ...
    ("notebooks/evaluate/moe-of-sod__v_e8_repro_scale1.ipynb", "experiments/v_e8_repro_scale1.json", "EVALUATE"),
    ...
    ("notebooks/train/moe-of-sod__v_e2_k2_s32.ipynb", "experiments/v_e2_k2_s32.json", "TRAIN"),
    ("notebooks/train/moe-of-sod__v_e4_k1_s32.ipynb", "experiments/v_e4_k1_s32.json", "TRAIN"),
    ...
    ("notebooks/train/moe-of-sod__v_e4_repro_nolb.ipynb", "experiments/v_e4_repro_nolb.json", "TRAIN"),
    ("notebooks/train/moe-of-sod__v_e4_repro_renorm.ipynb", "experiments/v_e4_repro_renorm.json", "TRAIN"),
    # Training finished correctly; only the evaluation was lost to the moe_type bug,
    # so these re-run in EVALUATE mode and pull their own checkpoints from the Hub.
    ("notebooks/evaluate/moe-of-sod__v_e4_repro_densectrl.ipynb", "experiments/v_e4_repro_densectrl.json", "EVALUATE"),
    # Training finished correctly; only the evaluation was lost to the moe_type bug,
    # so these re-run in EVALUATE mode and pull their own checkpoints from the Hub.
    ("notebooks/evaluate/moe-of-sod__v_e4_repro_nonectrl.ipynb", "experiments/v_e4_repro_nonectrl.json", "EVALUATE"),
    ...
    ("notebooks/evaluate/moe-of-sod__v_e2_loadbal.ipynb", "experiments/v_2expert_loadbal.json", "EVALUATE"),
    ("notebooks/evaluate/moe-of-sod__v_e4_loadbal.ipynb", "experiments/v_4expert_loadbal.json", "EVALUATE"),
    ("notebooks/evaluate/moe-of-sod__v_e2_gatedense.ipynb", "experiments/v_2expert_gatedense.json", "EVALUATE"),
    ("notebooks/evaluate/moe-of-sod__v_e4_gatedense.ipynb", "experiments/v_4expert_gatedense.json", "EVALUATE"),
]
