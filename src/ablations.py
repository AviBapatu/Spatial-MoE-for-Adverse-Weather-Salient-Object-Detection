...
def adjust_for_effective_batch(config: ExperimentConfig, target_effective: int):
...
def export_ablation_tables(registry_path: str = "experiments/registry.csv", out_dir: str = "experiments"):
